...
public class OpenGLView extends GLContinuousTextureView {
    ...
    private void initMine(){
        ...
        this.mPaint.setMaskFilter(new BlurMaskFilter(3, BlurMaskFilter.Blur.SOLID));//设置外发光

        this.mPaintGL.setLineWidth(5);
        this.mPaintGL.setStyle(Paint.Style.STROKE);
    }
    ...
    private GLPaint mPaintGL = new GLPaint();

    private void drawTriangleBeziers(ICanvasGL canvas){
        canvas.clearBuffer();
//        canvas.drawColor(Color.parseColor("#00000000"), PorterDuff.Mode.CLEAR);
        ...
        while (iterator.hasNext()) {
            ...
            mPath.close();
            //设置画笔透明度和RGB颜色
            mPaint.setColor(Color.argb((int) (255 * triangle.getAlpha()),triangleBezier.getR(),triangleBezier.getG(),triangleBezier.getB()));
            mPaintGL.setColor(Color.argb((int) (255 * triangle.getAlpha()),triangleBezier.getR(),triangleBezier.getG(),triangleBezier.getB()));
            canvas.drawLine(triangle.point1.x,triangle.point1.y,triangle.point2.x,triangle.point2.y,mPaintGL);
